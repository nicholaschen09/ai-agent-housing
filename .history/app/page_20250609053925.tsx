...
export default function Component() {
  const searchSuggestions = [
    ...
    "Founders focused on ed-tech or online learning",
    "Solutions",
    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6 py-16">
      <div className="max-w-4xl w-full text-center space-y-12">
        ...
        <div className="space-y-4">
          <h1 className="text-5xl md:text-6xl font-serif text-black leading-tight">The People Search Engine for</h1>
          <div className="flex items-center justify-center gap-2">
            <h2 className="text-5xl md:text-6xl font-serif text-black">University of Waterloo</h2>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  size="sm"
                  variant="secondary"
                  className="rounded-full bg-gray-400 hover:bg-gray-500 text-white text-xs px-3 py-1 h-6"
                >
                  UPGRADE
                </Button>
