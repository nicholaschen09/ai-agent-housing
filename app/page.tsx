    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6 py-16">
      ...
      <footer className="fixed bottom-0 left-0 right-0 py-4 text-center bg-white/80 backdrop-blur-sm border-t border-gray-100">
        <p className="text-sm text-gray-500 font-serif">
          By <a href="https://twitter.com/chimcis" target="_blank" rel="noopener noreferrer" className="text-red-600 hover:text-red-700 underline">@chimcis</a> and <a href="https://twitter.com/nicholaschen__" target="_blank" rel="noopener noreferrer" className="text-red-600 hover:text-red-700 underline">@nicholaschen__</a> © 2025
        </p>
      </footer>
    </div>
  )
